...
public class ObjetoListadoTareas {
    ...
    public ObjetoListadoTareas() {
    }

    public ObjetoListadoTareas(String sucursal, String idTarea, String descripcion, String usuario_responsable, String evidenciaAudio, String evidenciaVideo, String evidenciaImagen, String fechaAlta, String status) {
